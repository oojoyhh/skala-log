...
const toggleTextColor = () => {
    textColor.value = textColor.value === 'purple' ? '#42b883' : 'purple'
}
</script>
...
<template>
    <div class="practice-section">
        ...
        <button @click="toggleTextColor">글자 색상 변경</button>
        <br />
        ...
        <div :style="[baseBoxStyle, { width: boxWidth + 'px' }]">
            <p style="color: white; padding: 10px; text-align: center">가로크기: {{ boxWidth }}px 박스</p>
        </div>
    </div>
</template>
